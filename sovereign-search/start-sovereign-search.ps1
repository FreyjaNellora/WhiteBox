# Sovereign Search - one-click launcher (portable; paths derive from this file's location).
# Starts BOTH servers (SearXNG engine on :8888 + Sovereign face on :8890), query logging SILENCED,
...
Write-Host ""
Write-Host "  Starting Sovereign Search (engine + face, logging silenced)..." -ForegroundColor Green
...
# 2) face (Sovereign Search UI + API, 8890)
...
Write-Host "  Wipe local history anytime: sovereign-search\wipe-history.ps1" -ForegroundColor DarkGray
Write-Host ""
